...
import 'package:sq_music_alidrive/controller/controller_injec.dart';
...
import 'package:sq_music_alidrive/route/main_route.dart';
...
void main() async{
  ...
  EasyLoading.init();
  //初始化缓存地址
  await MusicCach.initDirectory();
  //初始化数据库
  DbServices.dbPath = await  getDatabasesPath();
  //依赖注入
